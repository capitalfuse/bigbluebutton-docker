...
#dockerize \
#    -template /etc/freeswitch/vars.xml.tmpl:/usr/local/freeswitch/conf/vars.xml \
#    -template /etc/freeswitch/autoload_configs/conference.conf.xml.tmpl:/usr/local/freeswitch/conf/autoload_configs/conference.conf.xml \

freeswitch -u freeswitch -g freeswitch -nonat -nf
